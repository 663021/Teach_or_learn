<%@ Page Title="" Language="C#" MasterPageFile="~/Main_page.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Async="true" Inherits="TEACH_OR_LEARN.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main_container" runat="server">
    <div class="form-horizontal">
        <div class="lines">
                <h4>Регистрация учетной записи ученика</h4>                          
                <hr />
                <asp:ValidationSummary runat="server" CssClass="text-danger" />
                <div class="form-group">
                    <asp:Label runat="server" AssociatedControlID="Email" CssClass="col-md-2 control-label">Имя</asp:Label>
                    <div class="col-md-10">
                        <asp:TextBox runat="server" ID="Names" CssClass="form-control" OnTextChanged="Names_TextChanged" AutoPostBack="true"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <asp:TextBox runat="server" ID="Email" CssClass="form-control" TextMode="Email" OnTextChanged="Email_TextChanged" AutoPostBack="true"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <asp:TextBox runat="server" ID="Login" CssClass="form-control" AutoPostBack="true" OnTextChanged="Login_TextChanged"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <asp:TextBox runat="server" ID="ConfirmPassword" CssClass="form-control" OnTextChanged="ConfirmPassword_TextChanged" AutoPostBack="true"/>
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <asp:Button runat="server" Text="Регистрация" CssClass="btn btn-default" OnClick="Unnamed6_Click" />
                    </div>
                </div>
          </div>
    </div>
